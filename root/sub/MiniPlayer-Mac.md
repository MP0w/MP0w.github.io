...
|![MiniPlayer Icon]({{ site.assets-path }}{{app.icon}}){: .profilepic}|[{% include appStoreButtonSVG.html %}](https://itunes.apple.com/us/app/miniplayer/id931202332?l=it&ls=1&mt=12)|
{: .products}
-------
{{app.description}}
